...
https://github.com/your-username/quickart-web
...
- ☁️ Cloud-based database integration using MongoDB Atlas  
- 🖼️ Image storage and fast delivery using AWS S3  
...
```bash
git clone https://github.com/your-username/quickart-mobile.git
```
...
### Categories
![Product Screen](img/categories.jpg)

###  Cart
![Cart Screen](img/cart.jpg)

###  Item Card
![Profile Screen](img/item_card.jpg)
